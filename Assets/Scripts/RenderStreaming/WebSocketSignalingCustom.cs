...
{
    public class WebSocketSignalingCustom : ISignaling
    {
        ...
        public WebSocketSignalingCustom(string url, float timeout, SynchronizationContext mainThreadContext)
        {
            m_url = url;
            m_timeout = timeout;
