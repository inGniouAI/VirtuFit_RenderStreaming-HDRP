...
namespace Siccity.GLTFUtility {
	...
	public class ShaderSettings {
		...
		public Shader GetDefaultMetallic() {
			...
			if (GraphicsSettings.renderPipelineAsset) return Shader.Find("GLTFUtility/HDRP/Standard (Metallic)");
			else
#endif
...
#if UNITY_2019_1_OR_NEWER
			if (GraphicsSettings.renderPipelineAsset) return Shader.Find("GLTFUtility/HDRP/Standard Transparent (Metallic)");
			else
#endif
...
#if UNITY_2019_1_OR_NEWER
			if (GraphicsSettings.renderPipelineAsset) return Shader.Find("GLTFUtility/HDRP/Standard (Specular)");
			else
#endif
...
#if UNITY_2019_1_OR_NEWER
			if (GraphicsSettings.renderPipelineAsset) return Shader.Find("GLTFUtility/HDRP/Standard Transparent (Specular)");
			else
#endif
